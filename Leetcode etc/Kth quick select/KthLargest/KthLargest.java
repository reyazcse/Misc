...
There is another algorithm : median of medians to find pivot in O(n) worst case. However the constant a in a*n is very large
and in real life we do not use that median of medians algo. Instead we go for randomized finding of pivot and we get expected 
