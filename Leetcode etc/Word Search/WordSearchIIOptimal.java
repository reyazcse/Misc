...
public class WordSearchIIOptimal {
	public List<String> findWords(char[][] board, String[] words) {
		if(board == null)
			return new ArrayList<>();
		
		WordSearchIIOptimal.Trie tr = new WordSearchIIOptimal().new Trie();
		...
		for(int i=0; i<board.length; i++) {
			for(int j=0; j<board[0].length; j++) {
				...
				dfs(board,tr,"", i, j, result, visited);
			}
		}
	...
	public void dfs (char[][]board, WordSearchIIOptimal.Trie trie, String prefix, int i, int j, Set<String>result, boolean[][] visited) {
	...
	public static void main(String[] args) {
		WordSearchIIOptimal obj = new WordSearchIIOptimal();
